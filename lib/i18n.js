const translations = {
  ...
  'auth.error.PASSWORDS_MISMATCH': { ar: 'كلمتا المرور غير متطابقتين', en: 'Passwords do not match' },
  'auth.error.INVALID_USERNAME': { ar: 'اسم المستخدم غير صالح (3-30 حرف)', en: 'Username must be 3-30 characters' },
  'auth.error.INVALID_EMAIL': { ar: 'عنوان البريد الإلكتروني غير صالح', en: 'Invalid email address' },
  'auth.error.WEAK_PASSWORD': { ar: 'كلمة المرور ضعيفة جداً (8 أحرف على الأقل)', en: 'Password must be at least 8 characters' },
  'auth.error.EMAIL_TAKEN': { ar: 'البريد الإلكتروني مستخدم بالفعل', en: 'Email already registered' },
  'auth.error.USERNAME_TAKEN': { ar: 'اسم المستخدم محجوز بالفعل', en: 'Username already taken' },

  // My Listings
  'my_listings.title': { ar: 'منتجاتي', en: 'My Listings' },
  'my_listings.add': { ar: 'أضف منتج', en: 'Add Listing' },
  'my_listings.empty': { ar: 'لا توجد منتجات بعد.', en: 'No listings yet.' },
  ...
  // Upgrade / Payment
  'upgrade.title': { ar: 'ترقية إلى Pro', en: 'Upgrade to Pro' },
